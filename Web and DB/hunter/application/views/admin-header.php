                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo base_url('assets/admin/') ?>assets/images/users/1.jpg" alt="user" class=""> <span class="hidden-md-down">Admin Panel &nbsp;<i class="fa fa-angle-down"></i></span> </a>
